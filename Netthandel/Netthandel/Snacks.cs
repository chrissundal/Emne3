...
{
    internal class Snacks : IProducts
    {
        ...
        public Snacks(string name, string category, int stock, int price, string measurement)
        {
            Name = name;
            Category = category;
            Stock = stock;
        ...
        {
            return new Snacks(Name, Category, stock, Price, Measurement);
        }
    }
}
