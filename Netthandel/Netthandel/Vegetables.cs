...
{
    internal class Vegetables : IProducts
    {
        ...
        public Vegetables(string name, string category, int stock, int price, string measurement)
        {
            Name = name;
            Category = category;
            Stock = stock;
        ...
        {
            return new Vegetables(Name, Category, stock, Price, Measurement);
        }
    }
}
