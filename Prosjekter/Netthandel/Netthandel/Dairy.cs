...
{
    internal class Dairy : IProducts
    {
        ...
        public Dairy(string name, string category, int stock, int price, string measurement)
        {
            Name = name;
            Category = category;
            Stock = stock;
        ...
        {
            return new Dairy(Name, Category, stock, Price, Measurement);
        }
    }
}
