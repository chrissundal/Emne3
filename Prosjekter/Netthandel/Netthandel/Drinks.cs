...
{
    internal class Drinks : IProducts
    {
        ...
        public Drinks(string name, string category, int stock, int price, string measurement)
        {
            Name = name;
            Category = category;
            Stock = stock;
        ...
        {
            return new Drinks(Name, Category, stock, Price, Measurement);
        }
    }
}
