...
namespace Netthandel
{
    internal class Meat : IProducts
    {
        ...
        public Meat(string name, string category, int stock, int price, string measurement)
        {
            Name = name;
            Category = category;
            Stock = stock;
        ...
        {
            return new Meat(Name, Category, stock, Price, Measurement);
        }
    }
}
